...
The script [04_pri_anal_model_bioch_BMSi_vars.R](https://github.com/verasls/BaSEIB_exercise_bone_health/blob/master/code/scripts/04_pri_anal_model_bioch_BMSi_vars.R) contains the same analyses, but with different dependent variables.
